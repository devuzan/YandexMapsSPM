...
frameworks=("YandexMapsMobile")
for framework in "${frameworks[@]}"; do
  archive_project_iphoneos "YandexMaps" "$framework"
done
for framework in "${frameworks[@]}"; do
  convert_frameworks_arm64_to_iphonesimulator "YandexMaps" "$framework"
done
for framework in "${frameworks[@]}"; do
  archive_project_iphonesimulator "YandexMaps" "$framework"
done
for framework in "${frameworks[@]}"; do
  create_xcframework "YandexMaps" "$framework"
done
